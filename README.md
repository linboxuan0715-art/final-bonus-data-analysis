...
The goal of this project is to complete a basic data science workflow in a Jupyter Notebook, including data loading, data cleaning, exploratory data analysis, visualization, and interpretation of findings.
...
The project uses the Gapminder dataset from Plotly's public dataset repository.
...
- Data inspection and missing value checking
- Feature engineering
...
The analysis shows that economic development is strongly associated with health outcomes, but income alone does not fully explain differences in life expectancy. Regional, social, institutional, and public health factors may also play important roles.
